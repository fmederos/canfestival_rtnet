...
void StartTimerLoop(TimerCallback_t _init_callback)
{
	...
	ret = rt_task_create(&timerloop_task, taskname, 0, 50, T_JOINABLE); //Cambio la prioridad de 50 a 5, para que tenga una prioridad mas baja, tratando de corregir el error "No buffer space available"
	if (ret) {
